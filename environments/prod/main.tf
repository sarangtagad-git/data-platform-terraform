...
# single_nat_gateway = false in prod — one NAT per AZ for high availability
# =============================================================================
module "networking" {
...
# force_destroy = false in prod — bucket CANNOT be deleted via terraform destroy
# raw_data_expiry_days = 730 — 2 years retention for production data
# =============================================================================
module "s3_data_lake" {
